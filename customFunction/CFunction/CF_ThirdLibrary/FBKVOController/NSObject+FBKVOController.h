...
//[self.KVOController observe:self.changeCoverImageView keyPath:@"image" options:NSKeyValueObservingOptionInitial|NSKeyValueObservingOptionNew block:^(id  _Nullable observer, id  _Nonnull object, NSDictionary<NSKeyValueChangeKey,id> * _Nonnull change) {
//    [selfWeak sendButtonStatusChange];
//}];
