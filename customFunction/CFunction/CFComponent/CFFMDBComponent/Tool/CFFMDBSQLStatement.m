...
#import "CFFMDBSQLStatement.h"
#import "CFFMDBConfiguration.h"

@implementation CFFMDBSQLStatement
...
+ (NSString *)CreatedSQLLibStringByName:(NSString *)nameString{
    ...
    NSString *pathString = [CFFMDBConfiguration SQLPath];
    BOOL isDir;
    ...
    NSString *dbpath = [CFFMDBConfiguration CompletePathByToken:nameString];
    return dbpath;
}
